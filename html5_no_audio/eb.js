...
Module['ready'] = new Promise(function(resolve, reject) {
  ...
  readyPromiseReject = reject;
      ...
      if (!Object.getOwnPropertyDescriptor(Module['ready'], '__Z14godot_web_mainiPPc')) {
        Object.defineProperty(Module['ready'], '__Z14godot_web_mainiPPc', { configurable: true, get: function() { abort('You are getting __Z14godot_web_mainiPPc on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
        Object.defineProperty(Module['ready'], '__Z14godot_web_mainiPPc', { configurable: true, set: function() { abort('You are setting __Z14godot_web_mainiPPc on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
      }
    

      if (!Object.getOwnPropertyDescriptor(Module['ready'], '__emwebxr_on_input_event')) {
        Object.defineProperty(Module['ready'], '__emwebxr_on_input_event', { configurable: true, get: function() { abort('You are getting __emwebxr_on_input_event on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
        Object.defineProperty(Module['ready'], '__emwebxr_on_input_event', { configurable: true, set: function() { abort('You are setting __emwebxr_on_input_event on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
      }
    

      if (!Object.getOwnPropertyDescriptor(Module['ready'], '__emwebxr_on_simple_event')) {
        Object.defineProperty(Module['ready'], '__emwebxr_on_simple_event', { configurable: true, get: function() { abort('You are getting __emwebxr_on_simple_event on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
        Object.defineProperty(Module['ready'], '__emwebxr_on_simple_event', { configurable: true, set: function() { abort('You are setting __emwebxr_on_simple_event on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
      }
...
if (!Object.getOwnPropertyDescriptor(Module, "GodotWebXR")) Module["GodotWebXR"] = () => abort("'GodotWebXR' was not exported. add it to EXPORTED_RUNTIME_METHODS (see the FAQ)");
if (!Object.getOwnPropertyDescriptor(Module, "GodotWebXR__user")) Module["GodotWebXR__user"] = () => abort("'GodotWebXR__user' was not exported. add it to EXPORTED_RUNTIME_METHODS (see the FAQ)");
...
if (!Object.getOwnPropertyDescriptor(Module, "GodotIME")) Module["GodotIME"] = () => abort("'GodotIME' was not exported. add it to EXPORTED_RUNTIME_METHODS (see the FAQ)");
if (!Object.getOwnPropertyDescriptor(Module, "GodotIME__user")) Module["GodotIME__user"] = () => abort("'GodotIME__user' was not exported. add it to EXPORTED_RUNTIME_METHODS (see the FAQ)");
